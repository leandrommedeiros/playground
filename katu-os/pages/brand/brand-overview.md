...
permalink: /katu-os/brand/brand-overview/
---
...
The following files define the KatuOS visual identity:

- **Raster master:** `KatuOS_logo_master.png`
- **Vector master (clean):** `KatuOS_logo_master_clean.svg`
- **Vector master (FX):** `KatuOS_logo_master_fx.svg`
...
- exporting PNG derivatives from the masters
...
- full logo (masters)
- icon-only version (jaguar head) *(optional)*
...
/brand/
 ...
 ├─ KatuOS_logo_master_clean.svg
 ├─ KatuOS_logo_master_fx.svg
 └─ exports/
```
